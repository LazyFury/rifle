    ...
    <div class="flex-1">
        ...
        <div class="swiper w-full h-250px bg-gray-300">
            ...
            <div class="swiper-wrapper !w-full">
                ...
                <div class="swiper-slide !w-full">
                    <img src="https://fastly.picsum.photos/id/441/800/400.jpg?hmac=PfbiUv548vtNVDw-xxuNtmgIIjPBakQFhPCZ5FYzqvA" alt="slide 1" class="w-full h-full object-cover object-center">
                </div>
                <div class="swiper-slide !w-full">
                    <img src="https://fastly.picsum.photos/id/442/800/400.jpg?hmac=PfbiUv548vtNVDw-xxuNtmgIIjPBakQFhPCZ5FYzqvA" alt="slide 2" class="w-full h-full object-cover object-center">
                </div>
                <div class="swiper-slide !w-full">
                    <img src="https://fastly.picsum.photos/id/443/800/400.jpg?hmac=PfbiUv548vtNVDw-xxuNtmgIIjPBakQFhPCZ5FYzqvA" alt="slide 3" class="w-full h-full object-cover object-center">
                </div>
            </div>
        </div>
        </div>
        ...
        @foreach(get_hot_posts(3) as $post)
            <div class="bg-gray-100  my-2 flex flex-row flex-wrap gap-2">
                <img src="https://fastly.picsum.photos/id/441/200/100.jpg?hmac=PfbiUv548vtNVDw-xxuNtmgIIjPBakQFhPCZ5FYzqvA" alt="{{
                    $post['title']
                }}" title="{{
                    $post['title']
